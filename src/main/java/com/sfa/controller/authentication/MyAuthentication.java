package com.sfa.controller.authentication;
...
public class MyAuthentication {
	...
	public OAuth2AccessToken testAccessToken(HttpServletRequest request, HttpServletResponse response,@RequestBody UserEntity userEntity) throws IOException {
		...
		Authentication userAuth = new UsernamePasswordAuthenticationToken(userEntity.getUserName(), userEntity.getUserPassword());
