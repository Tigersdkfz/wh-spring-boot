...
public class MenuServiceImpl implements MenuService {
	...
	@Override
	public List<MenuEntity> menuList(String roleid) {
		List<MenuEntity> idList = menuDao.getMenuByRoleId(roleid);
		if(idList.isEmpty()){
			throw new UnapprovedClientAuthenticationException("该用户角色无效！");
		}
		return idList;
	}
